...
@Data
public class ExchangeRecyclerMonthsAdapter extends RecyclerView.Adapter<ExchangeRecyclerMonthsAdapter.MyViewHolder> {
    private final Context mContext;
    private final List<Exchange> mExchanges;
    private int mIdIcon;

    public ExchangeRecyclerMonthsAdapter(Context context, List<Exchange> exchanges) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        int day = TimeUtil.getInstance().getNumberDay(mExchanges.get(position).getCreatedDate());
        holder.mTvTime.setText(String.format("%s %d", "Day", day));
