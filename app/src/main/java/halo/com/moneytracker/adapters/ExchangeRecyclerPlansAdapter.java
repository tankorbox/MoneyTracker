...
@Data
public class ExchangeRecyclerPlansAdapter extends RecyclerView.Adapter<ExchangeRecyclerPlansAdapter.MyViewHolder> {
    private final Context mContext;
    private final List<Exchange> mExchanges;
    private int mIdIcon;

    public ExchangeRecyclerPlansAdapter(Context context, List<Exchange> exchanges) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_exchange_plan, parent, false);
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.mTvTime.setText(String.format("%s %d %d"
                , TimeUtil.getInstance().getNameMonth(created)
                , TimeUtil.getInstance().getNumberDay(created)
                , TimeUtil.getInstance().getNumberYear(created)));
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        private final Switch mSwitchTraded;

        public MyViewHolder(View itemView) {
            super(itemView);
            mSwitchTraded = (Switch) itemView.findViewById(R.id.switchTradeExchange);
